(function () {
  ...
  const SERVICES = {
    "cut-women": {
      ...
      duration: "45 минут",
      price: "2 000 ₽",
      booking: "https://dkd.su/2693/s/20644859",
      text: [
    ...
    "color-complex": {
      ...
      duration: "4 часа",
      price: "7 000 ₽",
      booking: "https://dkd.su/2693/s/1906445",
      text: [
    ...
    "color-one": {
      ...
      price: "3 500 ₽",
      booking: "https://dkd.su/2693/s/9204576",
      text: [
    ...
    "color-tone": {
      ...
      duration: "1 час",
      price: "3 500 ₽",
      booking: "https://dkd.su/2693/s/10368130",
      text: [
        "Выполняется с использованием брендов Matrix и Armalla.",
      ],
    },
    "color-total": {
      ...
      duration: "2,5 часа",
      price: "5 500 ₽",
      booking: "https://dkd.su/2693/s/17381698",
      text: [
        "Выполняется с использованием брендов Matrix и Armalla.",
      ],
    },
    ...
    "perm-vertical": {
      ...
      duration: "4 часа",
      price: "7 500 ₽",
      booking: "https://dkd.su/2693/s/19404612",
      text: [
    ...
    "perm-bio": {
      ...
      duration: "2,5 часа",
      price: "6 500 ₽",
      booking: "https://dkd.su/2693/s/6999327",
      text: [
    ...
    "perm-men": {
      ...
      duration: "2,5 часа",
      price: "от 5 000 ₽",
      booking: "https://dkd.su/2693/s/20318184",
      text: [
    ...
    "keratin-straight": {
      ...
      duration: "2 часа",
      price: "4 500 ₽",
      booking: "https://dkd.su/2693/s/2931635",
      text: [
    ...
    "keratin-botox": {
      ...
      duration: "2 часа",
      price: "4 500 ₽",
      booking: "https://dkd.su/2693/s/9378188",
      text: [
    ...
    "keratin-cold": {
      ...
      duration: "1 час",
      price: "3 500 ₽",
      booking: "https://dkd.su/2693/s/20713914",
      text: [
    ...
    "keratin-anti": {
      ...
      duration: "2 часа",
      price: "5 000 ₽",
      booking: "https://dkd.su/2693/s/23115593",
      text: [
    ...
    "care-peel": {
      ...
      duration: "1 час",
      price: "1 500 ₽",
      booking: "https://dkd.su/2693/s/18038496",
      text: [
    ...
    "care-volume": {
      ...
      duration: "2 часа",
      price: "от 4 500 ₽",
      booking: "https://dkd.su/2693/s/9919252",
      text: [
  ...
  const renderService = (id) => {
    ...
    document.getElementById("service-book").href = data.booking || BOOKING_URL;
  };
