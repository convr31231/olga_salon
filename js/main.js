(function () {
  ...
  const revealEls = [
    ...document.querySelectorAll("main .section-head, main .service-row, main .service-group, main .philosophy-copy, main .master, main .gallery-item, main .price-row, main .quiz-board, main .about-copy, main .adv-item, main .ig-grid, main .contacts-copy, main .booking-copy, main .timeline li, main .trust, main .masters-single"),
  ...
  const renderLightbox = (index) => {
    visibleWorks = galleryItems.filter((item) => !item.classList.contains("is-hidden"));
